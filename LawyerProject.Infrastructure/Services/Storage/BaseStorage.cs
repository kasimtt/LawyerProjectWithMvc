...
namespace LawyerProject.Infrastructure.Services.Storage
{
    public class BaseStorage
    {
        protected delegate bool HasFile(string pathOrContainerName, string fileName);
        #region renameUnSuccessMethod
      /*  protected async Task<string> RenameFileAsync(string pathOrContainerName,  string fileName, HasFile hasFileMethod)
        {
